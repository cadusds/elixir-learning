defmodule ExMon2 do
  ...
  alias ExMon2.{Player,Game}
  alias ExMon2.Game.{Actions,Status}


  @computer_name "Robozão"
  @computer_moves [:move_avg, :move_random, :move_heal]

  def create_player(name, move_avg, move_random, move_heal) do
    Player.build(name, move_random, move_avg, move_heal)
  end
